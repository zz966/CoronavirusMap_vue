<template>
  <div>
    ...
    <h2>COVID-19 current case number - daily report</h2>
    <h5>{{reportTime}}</h5>
    <table align="center">
      <thead>
        <tr>
...
export default {
  ...
  data() {
    return {
      ...
      mapOptions: {
        ...
        title: {
          text: "COVID-19 current case number in each state - daily report"
        },
        subtitle: {
          text: ""
        },
  ...
  methods: {
    setMaptData() {
      ...
      let subtitle = `Updated every 24 hours  lastest update on <strong>${this.reportTime}</strong>`;
